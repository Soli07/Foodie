...
.dropdown-content {
  ...
  min-width: 160px;  font-family:Montserrat, sans-serif;
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">Foodie <span>.</span> Restaurant</a>
               </div>
<?php if((!empty($_SESSION["role"]) && $_SESSION["role"]=="user")) {?>
  ...
  <div class="dropdown-content">
    ...
    <a href="signout.php">Logout</a>
                         ...
                         <!--<li><a href="signout.php">Logout</li>-->
 ...
 <div class="collapse navbar-collapse">
  ...
  <div class="dropdown-content">
    ...
    <a href="signout.php">Logout</a>
                    ...
                    <li><a href="contact.php">Delete Item</a></li>
...
<?php }elseif(!empty($_SESSION["role"]) && $_SESSION["role"] == "delv"){?>
      <!-- MENU LINKS -->
      <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">                   

                         <li><a href="#home" class="smoothScroll">Home</a></li>
                         <li><a href="delOrders.php" class="smoothScroll">Orders</a></li>
                    </ul>
